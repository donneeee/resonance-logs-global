...
using DenseSlotArray = ModuleOptimizerGpuShared::DenseSlotArray;
using DenseModuleData = ModuleOptimizerGpuShared::DenseModuleData;
...
#ifdef USE_OPENCL
    if (combination_size <= 5 && TestOpenCL()) {
