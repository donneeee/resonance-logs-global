...
LangString failedToKillApp ${LANG_ENGLISH} "Failed to kill {{product_name}}.$\nPlease close it first then try again"
...
LangString webview2AbortError ${LANG_ENGLISH} "Failed to install WebView2! The app can't run without it.$\nTry restarting the installer."
...
LangString deleteAppData ${LANG_ENGLISH} "Delete application data (removes settings, profiles, logs, caches, and saved AppData)"
